...
if __name__ == "__main__":
    ...
    DATA_PATH = working_directory + "/sources/data_en_train_with_parent.csv"
        ...
        for dataset in DATASETS:
            ...
            for max_len in max_lengths:
                ...
                input_ids, attention_masks, labels, num_categories, unique_categories = tokenize_data(
                    df_current.description.values, df_current.category.astype("category"),
